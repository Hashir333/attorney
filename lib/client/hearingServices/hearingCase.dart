...
class HearingCaseScreen extends StatefulWidget {
  @override
  _HearingCaseScreenState createState() => _HearingCaseScreenState();
}

class _HearingCaseScreenState extends State<HearingCaseScreen> {
  Helper? helper;
        ...
        children: <Widget>[
          ...
          Expanded(
            child: Container(
              ...
              height: 45,
              child: Text(
                'Next Date of Hearing'.toUpperCase(),
                style: TextStyle(
                    color: Utility.whiteColor,
                    fontSize: 18,
