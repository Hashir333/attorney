...
class InterimOrderCaseScreen extends StatefulWidget {
  @override
  _InterimOrderCaseScreenState createState() => _InterimOrderCaseScreenState();
}

class _InterimOrderCaseScreenState extends State<InterimOrderCaseScreen> {
  Helper? helper;
        ...
        children: <Widget>[
          ...
          Expanded(
            child: Container(
              ...
              height: 45,
              child: Text(
                'Interim Order/Last Order of Court'.toUpperCase(),
                style: TextStyle(
                    color: Utility.whiteColor,
                    fontSize: 17,
              ...
              children: [
                Expanded(
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      border: InputBorder.none,
                      hintText: 'Select Date of your Court Order'.toUpperCase(),
                      hintStyle: TextStyle(
                        fontSize: 15.0,
                        color: Utility.textBoxBorderColor,
                      ),
