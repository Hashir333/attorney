...
class RequestedAttestedCaseDetailScreen extends StatefulWidget {
  final int caseId;

  RequestedAttestedCaseDetailScreen(this.caseId);

  @override
  _RequestedAttestedCaseDetailScreenState createState() =>
      _RequestedAttestedCaseDetailScreenState();
}

class _RequestedAttestedCaseDetailScreenState
    extends State<RequestedAttestedCaseDetailScreen> {
  Helper? helper;
              ...
              ? (paymentScreenshot == null
                  ? Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          //Navigator.push(context, MaterialPageRoute(builder: (context) => PaymentScreen(submittedCase!.id, message)));
                          // InkWell(
                          //   onTap: () {
                          //     getImages();
                          //   },
                          ...
                          InkWell(
                            onTap: () {
                              ...
                              //     apiUploadInitialPayment(
                              //         'initial', responseData.id, responseData.amount);
                              //   }
                              // }
                              // });
                            },
                        ...
                        children: [
                          InkWell(
                            onTap: () {
                              ...
                              //   if (responseData.response_desc == 'SUCCESS') {
                              //     apiUploadInitialPayment(
                              //         'final', responseData.id, responseData.amount);
                              //   }
                              // });
                            },
                            child: Container(
                            ...
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  border:
                                      Border.all(color: Utility.primaryColor),
                                ),
                                child: Container(
                              ...
                              Container(
                                alignment: Alignment.centerLeft,
                                child: Text(
                                  'I want delivery on my shipping address',
                                  style: TextStyle(
                                      fontSize: 15,
