...
class RequestedNewPaperCaseDetailScreen extends StatefulWidget {
  final int caseId;
  RequestedNewPaperCaseDetailScreen(this.caseId);

  @override
  _RequestedNewPaperCaseDetailScreenState createState() =>
      _RequestedNewPaperCaseDetailScreenState();
}

class _RequestedNewPaperCaseDetailScreenState
    extends State<RequestedNewPaperCaseDetailScreen> {
  Helper? helper;
...
class Helper {
      ...
      child: Column(
        children: [
          ...
          caseDetails!.caseDetailList[caseDetails!.caseDetailList.length - 1]
                      .type ==
                  'attorney_case_news_paper_charges_update'
  ...
  void apiDelivery() async {
    ...
    params['case_id'] = caseId.toString();
    params['delivery_type'] = deliveryOption.toString();
    ...
    Dio dio = new Dio();
    dio
        .post(CUSTOMER_CASE_DELIVERY_URL,
            data: formData,
            options: Options(
              method: 'POST',
              headers: headers,
  ...
  void apiGetCaseById() {
    ...
    http
      ...
      print(mappingResponse);
      print('caseDetails!.caseDetailList');
      if (mappingResponse['success'] == true) {
