...
import 'package:attorney/auth/NewPassword.dart';
...
class Helper {
  ...
  Helper(this.context, this.updateState, this.showProgressDialog) {
    ...
    // mobileController.text = '03354155003';
  }
    ...
    try {
      await auth2.signInWithCredential(credential).then((value) {
        ...
        Navigator.pushAndRemoveUntil(
            context,
            MaterialPageRoute(
                builder: (context) => NewPasswordScreen(mobileController.text)),
            (route) => false);
      });
      print("successful");
