...
class AttorneyNewsPaperCaseDetailScreen extends StatefulWidget {
  final int caseId;
  AttorneyNewsPaperCaseDetailScreen(this.caseId);

  @override
  _AttorneyNewsPaperCaseDetailScreenState createState() =>
      _AttorneyNewsPaperCaseDetailScreenState();
}

class _AttorneyNewsPaperCaseDetailScreenState
    extends State<AttorneyNewsPaperCaseDetailScreen> {
  Helper? helper;
...
class Helper {
                  ...
                  child: Column(
                    children: [
                      Container(
                        alignment: Alignment.centerLeft,
                        child: Text(
                          'Enter the Charges of News Paper',
                          style: TextStyle(
                                ...
                                Expanded(
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          'Charges of News Paper'.toUpperCase(),
                                      hintStyle: TextStyle(
                                        fontSize: 15.0,
                                        color: Utility.textBoxBorderColor,
                                      ),
                              ...
                              ? InkWell(
                                  onTap: () {
                                    if (casePagesController.text.length > 0) {
                                      ...
                                      showToast(
                                          'Please enter the Charges of News Paper');
                                    }
                                  },
                                  child: Container(
          ...
          (caseDetails!.caseDetailList[caseDetails!.caseDetailList.length - 1]
              ...
              ? InkWell(
                  ...
                  child: Container(
                    ...
                    alignment: Alignment.center,
                    child: Text(
                      'Mark as Publish Ad in News Paper'.toUpperCase(),
                      style: TextStyle(
                          fontSize: 18,
                          color: Utility.textWhiteColor,
                          fontWeight: FontWeight.bold),
                ...
                ? Row(
                    ...
                    children: [
                      Container(
                        ...
                        width: MediaQuery.of(context).size.width - 60,
                        child: Text(
                          'Name of News Paper: ${caseDetails!.news_paper_name}',
                          maxLines: 4,
                          style: TextStyle(
                              fontSize: 15, fontWeight: FontWeight.bold),
                        ),
            ...
            ? Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      // caseDetails!.caseDetailList[index].caseDetailImage != null? InkWell(
                      //   onTap: (){
                      //     if(caseDetails!.caseDetailList[index].caseDetailImage != null){
                      //       showImageViewer(context, Image.network(caseDetails!.caseDetailList[index].caseDetailImage!.url).image, swipeDismissible: true);
                      //     }
                      //   },
                      //   child: Container(
                      //     height: 150,
                      //     child: CachedNetworkImage(
                      //       imageUrl: caseDetails!.caseDetailList[index].caseDetailImage!.url,
  ...
  void apiUpdateCasePages() {
    ...
    headers['Accept'] = 'application/json';
    params['case_id'] = caseId.toString();
    params['charges'] = casePagesController.text.toString();

    print(BASE_URL + 'case/update-from-attorney/new-paper-charges');
    http
        .post(
            Uri.parse(BASE_URL + 'case/update-from-attorney/new-paper-charges'),
            headers: headers,
            body: params)
        .then((response) async {
      showProgressDialog(false);
  ...
  void apiMarkSubmitAd() {
    ...
    print(SubmIT_AD_BY_ATTORNEY_URL);
    http
        .post(Uri.parse(SubmIT_AD_BY_ATTORNEY_URL),
            headers: headers, body: params)
        .then((response) async {
      showProgressDialog(false);
      Map mappingResponse = jsonDecode(response.body);
